...
def plot_one_box( n_image , x, im, color=(128, 128, 128), label=None, line_thickness=3 ):
    ...
    #cv2.imwrite(n_image  ,im)
    
    if x1 > 1000 and w > 1000:
        crop_img = im[y1:h ,x1:w]
        main.load_image(crop_img , n_image)
        #cv2.imwrite(n_image + '_1' + '.png'  , i_detect)
        #im[y1:h ,x1:w] = i_detect
    ...
    if x1 < 1000 and w < 1000:
        ...
        #im[y1:h ,x1:w] = i_detect
        #cv2.imwrite(n_image + '_2' + '.png'  ,i_detect)
        #im = i_detect
    if label:
